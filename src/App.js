...
import DesktopModel from './components/modal/DesktopModel';
...
function App() {
  ...
  return (
    <React.Fragment>
      ...
      <header className='max-w-7xl md:flex justify-between items-center mx-auto my-8 w-11/12'> 
        <div>
  ...
  <path d="M8.22724 4.5C9.38194 2.5 12.2687 2.5 13.4234 4.5L19.0526 14.25C20.2073 16.25 18.7639 18.75 16.4545 18.75H5.19615C2.88675 18.75 1.44338 16.25 2.59808 14.25L8.22724 4.5Z" fill="#EB5757"/>
        ...
        <div 
          className="md:m-0 flex mx-auto my-10 w-[300px] rounded-md shadow font-mulish"
          onClick={modelHandler}>
          <div className="px-4 py-4 border-r-2 border-gray-100 text-sm">Helsinki, Finland</div>
          <div className="px-4 py-4 border-r-2 border-gray-100 text-sm">Add guests</div>
          <div className="px-4 py-4 text-sm">
            <FontAwesomeIcon className='text-[#EB5757] text-lg' icon={faSearch} />
          </div>
        </div>
      </header>
      ...
      <footer className='max-w-7xl flex justify-center gap-x-2 py-6 mt-20 mx-auto'>
        ...
        <a className='text-[#828282] font-bold' href="https://twitter.com/Rohitgour03">Rohitgour03</a>
        <a className='text-[#828282]' href="https://devchallenges.io/">devChallenges.io</a>
      </footer>
